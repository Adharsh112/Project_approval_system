<%-- 
    Document   : Students
    Created on : Jun 7, 2023, 7:26:42 PM
    Author     : Lenovo
--%> 
...
<head>
  ...
  <title>PAS-Projects Student </title> 
...
if(ss!=null){
   ...
   <script>  window.alert("Student Verified Successfully");</script>
 <% } else  if(ss.equalsIgnoreCase("NotInserted")) {%>    
   <script>  window.alert("Student Verified Failed");</script>    <% }
else  if(ss.equalsIgnoreCase("Deleted")) {%>    
   <script>  window.alert(" Student Deleted Successfully");</script>    <% }
   else  if(ss.equalsIgnoreCase("NotDeleted")) {%>    
   <script>  window.alert(" Student Deleting Failed");</script>    <% }
else  if(ss.equalsIgnoreCase("Updated")) {%>    
   <script>  window.alert("  Updated Successfully");</script>    <% }
   else  if(ss.equalsIgnoreCase("NotUpdated")) {%>    
   <script>  window.alert("  Updating Failed");</script>    <% }
        ...
        <ul class="nav">
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="ui-basi">
              <ul class="nav flex-column sub-menu"> 
                ...
                <li class="nav-item"> <a class="nav-link" href="Students.jsp?st=delete">Delete Students</a></li>
               </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-bas" aria-expanded="false" aria-controls="ui-bas">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title">Requests & Permission</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-bas">
              <ul class="nav flex-column sub-menu"> 
                 <li class="nav-item"> <a class="nav-link" href="hod.jsp?st=per"> Permission Hod</a></li>
                <li class="nav-item"> <a class="nav-link" href="ig.jsp?st=per"> Permission Ig</a></li>   
...
%>
 <h4 class="card-title">Add Students</h4>
                  <form class="form-sample" action="./ig" method="post"  enctype="multipart/form-data" > 
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">IG Name</label>
                          <div class="col-sm-9">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="Add IG">
                          </div>
                        </div>
                      </div>
                    </div> 
...
<% } else  if(st.equalsIgnoreCase("verify")) {
          %>
                  
           <h4 class="card-title">verify Students</h4>
                    <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
  <tr>  
...
<tr>
  <td class="py-1"> <%=rs.getString(1)%> </td>   
  <td> <%=rs.getString(2)%></td>   
  <td>   <form class="form-sample" action="./students" method="post"  enctype="multipart/form-data" > 
                     <input type="hidden"  name="type"  value="verify"/>          
          <input  type="hidden" name="id" value="<%=rs.getString(1)%>">
                          <div class="col-sm-9">    
         
   <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="Verify">
      </form>  </td>  
</tr>                
<%}  %>  
  </tbody>  </table>  </div>
...
<% }else  if(st.equalsIgnoreCase("delete")) {
    %> 
     <h4 class="card-title">Delete Internal Guide</h4>
                    <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
  <tr>  
...
<%}  %>  
    ...
    %> 
     ...
     <h4 class="card-title">Update Internal Guide</h4>
                 <% 
          String sql="SELECT * FROM ig";
          Statement stmt=connect.createStatement();
				 ResultSet rs =stmt.executeQuery(sql);
					String idname="";
                                        %>
                                         <div class="row">
                                             <form action="ig.jsp?st=updated" method="post">
...
String id=request.getParameter("id"); 
          Statement stmt=connect.createStatement();
         String updatesql="SELECT * FROM ig where igid='"+id+"'";   
                    ...
                    <option value="civil">CIVIL</option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label"></label>
                          <div class="col-sm-9">
                             <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="Update IG">
