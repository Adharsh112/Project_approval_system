<%-- 
    Document   : hod
    Created on : Jun 7, 2023, 5:36:13 PM
    Author     : Lenovo
--%>
...
if(ss!=null){
   ...
   <script>  window.alert("Hod Added Successfully");</script>
 <% } else  if(ss.equalsIgnoreCase("NotInserted")) {%>    
   <script>  window.alert("Hod Adding Failed");</script>    <% }
else  if(ss.equalsIgnoreCase("Deleted")) {%>    
   <script>  window.alert(" Hod Delete Successfully");</script>    <% }
   else  if(ss.equalsIgnoreCase("NotDeleted")) {%>    
   <script>  window.alert(" Hod Deleting Failed");</script>    <% }
else  if(ss.equalsIgnoreCase("Updated")) {%>    
   <script>  window.alert(" Hod Updated Successfully");</script>    <% }
   else  if(ss.equalsIgnoreCase("Permission")) {%>    
   <script>  window.alert(" Hod Permission Successfully");</script>    <% }
...
%>
 <h4 class="card-title">Add Hod </h4>
                  <form class="form-sample" action="./hod" method="post"  enctype="multipart/form-data" > 
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Hod Name</label>
                          <div class="col-sm-9">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="Add Hod">
                          </div>
                        </div>
                      </div>
                    </div> 
      ...
      <%} else  if(st.equalsIgnoreCase("view")) {
          %>
                    <h4 class="card-title">View Hods</h4>
...
<% }else  if(st.equalsIgnoreCase("delete")) {
    %> 
     <h4 class="card-title">Delete Hod</h4>
                    <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
  <tr>  
...
<%}  %>  
    ...
    %> 
     ...
     <h4 class="card-title">Update Hod</h4>
                 <% 
          String sql="SELECT * FROM hod";
          Statement stmt=connect.createStatement();
				 ResultSet rs =stmt.executeQuery(sql);
					String idname="";
                                        %>
                                         <div class="row">
                                             <form action="hod.jsp?st=updated" method="post">
...
String id=request.getParameter("id"); 
          Statement stmt=connect.createStatement();
         String updatesql="SELECT * FROM hod where hodid='"+id+"'";   
	ResultSet rs1 =stmt.executeQuery(updatesql);
          if (rs1.next()) { 
    %> 
   <br>
   <h4 class="card-title">Update Hod :: <%=id%> --<%=rs1.getString(2)%> </h4> 
         <form class="form-sample" action="./hod" method="post"  enctype="multipart/form-data" > 
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                    ...
                    <option value="civil">CIVIL</option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Password</label>
                          <div class="col-sm-9">
                            <input type="text" name="password"  value="<%=rs1.getString(4)%>" class="form-control" required>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label"></label>
                          <div class="col-sm-9">
                             <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="Update Hod">
...
<%}
            ...
            <h4 class="card-title">Permission Hod</h4>
                    <div class="table-responsive">
                    <table class="table table-striped">
                      <thead>
  <tr>  
