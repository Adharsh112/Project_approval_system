<%-- 
    Document   : ig
    Created on : Jun 7, 2023, 7:13:35 PM
    Author     : Lenovo
--%> 
...
if(ss!=null){
   ...
   <script>  window.alert("IG Added Successfully");</script>
 <% } else  if(ss.equalsIgnoreCase("NotInserted")) {%>    
   <script>  window.alert("IG Adding Failed");</script>    <% }
else  if(ss.equalsIgnoreCase("Deleted")) {%>    
   <script>  window.alert(" IG Delete Successfully");</script>    <% }
   else  if(ss.equalsIgnoreCase("NotDeleted")) {%>    
   <script>  window.alert(" IG Deleting Failed");</script>    <% }
else  if(ss.equalsIgnoreCase("Updated")) {%>    
   <script>  window.alert(" IG Updated Successfully");</script>    <% }
   else  if(ss.equalsIgnoreCase("Permission")) {%>    
   <script>  window.alert(" IG Permission Successfully");</script>    <% }
...
%>
 <h4 class="card-title">Add Internal Guide </h4>
      ...
      <%} else  if(st.equalsIgnoreCase("view")) {
          %>
                    <h4 class="card-title">View Internal Guide </h4>
...
<tr>
  <td class="py-1"> <%=rs.getString(1)%> </td>   
  <td> <%=rs.getString(2)%></td>   
  <td>   <form class="form-sample" action="./ig" method="post"  enctype="multipart/form-data" > 
