 ...
 * @author Lenovo
 */
public class ig extends HttpServlet {
...
String ff5=f5.getString();  System.out.println("Branch  ::"+ff5);
 ...
 String its= hod.Addig(ff2,ff3,ff6,ff4,ff5);
 
 
 if(its.equalsIgnoreCase("Inserted"))
                 {  response.sendRedirect("ig.jsp?v="+its+"");}
             else{  response.sendRedirect("ig.jsp?v="+its+"");}
...
String ff7=f7.getString();  System.out.println("phone   ::"+ff7); 
 ...
 String its= hod.updateig(ff4,ff5,ff6,ff7,ff2,ff3);
