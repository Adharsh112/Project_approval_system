...
String ff5=f5.getString();  System.out.println("Branch  ::"+ff5);
 ...
 String its= hod.Addhod(ff2,ff3,ff6,ff4,ff5);
 
 
 if(its.equalsIgnoreCase("Inserted"))
                 {  response.sendRedirect("hod.jsp?v="+its+"");}
             else{  response.sendRedirect("hod.jsp?v="+its+"");}
...
String ff7=f7.getString();  System.out.println("phone   ::"+ff7); 
 ...
 if(its.equalsIgnoreCase("Updated"))
  ...
  }else if(type.equalsIgnoreCase("pdelete")){  
        FileItem f2=(FileItem)list.get(1);    
     String ff2=f2.getString();  System.out.println("file name   ::"+ff2); 
     String its= hod.DeleteProject(ff2);
 ...
 if(its.equalsIgnoreCase("Permission"))
   ...
   }else if(type.equalsIgnoreCase("acce")){ 
         FileItem f2=(FileItem)list.get(1);
         FileItem f3=(FileItem)list.get(2); 
         FileItem f4=(FileItem)list.get(3);    
     String ff2=f2.getString();  System.out.println("file name   ::"+ff2); 
     ...
     String its= hod.Accepted(ff2,ff3,ff4);
      
  if(ff2.equalsIgnoreCase("ig")){
                if(its.equalsIgnoreCase("Updated"))
                 {  response.sendRedirect("Iprojects.jsp?v="+its+"");}
             else{  response.sendRedirect("Iprojects.jsp?v="+its+"");}
  }else   if(ff2.equalsIgnoreCase("pic")){
                
                if(its.equalsIgnoreCase("Updated"))
                 {  response.sendRedirect("Pprojects.jsp?v="+its+"");}
             else{  response.sendRedirect("Pprojects.jsp?v="+its+"");}
   
       }else   if(ff2.equalsIgnoreCase("hod")){           
                
                System.out.println("ff3 1  ::"+ff3);
                System.out.println("its 1  ::"+its);
                  if(its.equalsIgnoreCase("Updated"))
                 {  
                     System.out.println("ff3 2  ::"+ff3);
                     if(ff3.equalsIgnoreCase("Accepted"))
                 {  
                     System.out.println("ff3 33  ::"+ff3);
                        FileItem f5=(FileItem)list.get(4);  
                        String ff5=f5.getString();  System.out.println("email id  ::"+ff5); 
                        String is= hod.SendEmails(ff5,ff4);
                 }
                     
                     response.sendRedirect("Hprojects.jsp?v="+its+"");}
             else{  response.sendRedirect("Hprojects.jsp?v="+its+"");}
