<%-- 
    Document   : Pprojects
    Created on : Jun 9, 2023, 12:28:45 AM
    Author     : Lenovo
--%> 
...
if(email !=null){ 
String sid=session.getAttribute("picid").toString(); 
...
<head>
  ...
  <title>PAS-Projects PICHome </title> 
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo mr-5" href="Pichome.jsp"><img src="images/logo.svg" class="mr-2" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="Pichome.jsp"><img src="images/logo-mini.svg" alt="logo"/></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="Pichome.jsp">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="authq">
              <ul class="nav flex-column sub-menu"> 
                ...
                <li class="nav-item"> <a class="nav-link" href="Pprojects.jsp?st=students"> View Students </a></li> 
                <li class="nav-item"> <a class="nav-link" href="Pprojects.jsp?st=Approval"> Approval Projects</a></li> 
                <li class="nav-item"> <a class="nav-link" href="Pprojects.jsp?st=view"> View Projects</a></li>
              </ul>
            </div>
          </li> 
...
<tr>
  ...
  <td>   <form class="form-sample" action="./hod" method="post"  enctype="multipart/form-data" > 
                     <input type="hidden"  name="type"  value="acce"/>  
                      <input type="hidden"  name="per"  value="pic"/>
