        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="index.jsp">
              ...
              <span class="menu-title">PAS-Home</span>
            </a>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu"> 
                ...
                <li class="nav-item"> <a class="nav-link" href="hodlogin.jsp">HOD</a></li>
                <li class="nav-item"> <a class="nav-link" href="piclogin.jsp">Project In-Charge</a></li>
                <li class="nav-item"> <a class="nav-link" href="iglogin.jsp">Internal Guide</a></li>
                <li class="nav-item"> <a class="nav-link" href="studentlogin.jsp">Student</a></li>
              </ul>
            </div>
          </li>
