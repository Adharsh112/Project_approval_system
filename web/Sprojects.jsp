<%-- 
    Document   : Sprojects
    Created on : Jun 7, 2023, 11:16:55 PM
    Author     : Lenovo
--%> 
...
if(ss!=null){
   ...
   <script>  window.alert("Project Added Successfully");</script>
 <% } else  if(ss.equalsIgnoreCase("NotInserted")) {%>    
   <script>  window.alert("Project Adding Failed");</script>    <% }
else  if(ss.equalsIgnoreCase("Deleted")) {%>    
   <script>  window.alert(" Project Delete Successfully");</script>    <% }
   else  if(ss.equalsIgnoreCase("NotDeleted")) {%>    
   <script>  window.alert(" Project Deleting Failed");</script>    <% }
else  if(ss.equalsIgnoreCase("Updated")) {%>    
   <script>  window.alert(" Project Updated Successfully");</script>    <% }
   else  if(ss.equalsIgnoreCase("NotUpdated")) {%>    
   <script>  window.alert(" Project Updating Failed");</script>    <% }
...
%>
        <h4 class="card-title">Add Projects </h4>
                  <form class="form-sample" action="./Projects" method="post"  enctype="multipart/form-data" > 
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Projects Name</label>
                          <div class="col-sm-9">
                              <input type="hidden" class="form-control" name="type" value="add">
                              <input type="hidden" class="form-control" name="sid" value="<%=sid%>"> 
                              <input type="hidden" class="form-control" name="roll" value="<%=roll%>">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                              ...
                              <input type="file" name="code" class="form-control" required>
                          </div>
                        </div>
                      </div> 
                         <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="Add Project">
                    ...
                    <div class="col-12">
                      <div class="table-responsive">
                        <table id="example" class="display expandable-table" style="width:100%">
                          <thead>
                           <tr> <th>  Project ID  </th>  <th>  Branch </th>    
                                <th> Project Name </th>  <th>  Abstract  </th>     <th>  Synopsis  </th>  <th>  Report  </th> 
                                 <th>  Code  </th> <th> IG Status </th>   </tr>
                          </thead>
                           <tbody>
                                <%
         
          String sql="SELECT * FROM projects where sid='"+sid+"' and rollnumber='"+roll+"' ";
...
<tr>
  ...
  <td> <%=AES.decrypt(rs.getString(8))%></td>   
  <td> <%=AES.decrypt(rs.getString(9))%></td>  
...
<%}%>    
  ...
  <tr>  
      ...
      <th>  Project ID  </th>     <th> Project Name </th>     <th>  Action </th>  </tr>
                      </thead>
                      <tbody>
                 <% 
          String sql="SELECT * FROM projects where  sid='"+sid+"' and rollnumber='"+roll+"'";
...
<tr>
  ...
  <td>   <form class="form-sample" action="./hod" method="post"  enctype="multipart/form-data" > 
                     <input type="hidden"  name="type"  value="pdelete"/>          
