<%-- 
    Document   : adminlogin
    Created on : Jun 7, 2023, 10:36:56 AM
    Author     : Lenovo
--%>
...
if(ss!=null){
 ...
 <% } else  if(ss.equalsIgnoreCase("NotInserted")) {%>    
   <script>  window.alert("login Unsuccessfully");</script>    <% }}  %>
              ...
              <form action="./alogin" method="post" class="pt-3">
                <div class="form-group">
                    <input type="hidden" name="type" value="admin">
                  <input type="text" name="admin" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Username">
                </div>
                <div class="form-group">
